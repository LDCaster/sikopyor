                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bold">SIKOPYOR</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Lupa Password 🔒</h4>
                        <p class="mb-4">Masukkan alamat email Anda dan kami akan mengirimkan instruksi untuk mereset
                            kata sandi Anda.</p>
